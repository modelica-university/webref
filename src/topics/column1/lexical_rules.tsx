...
const numberDescription = (
    <table className="table">
        <tbody>
            ...
            <tr>
                <td>
                    <Code src=".7" /> (as one example) is <b>not</b> a valid floating point number in Modelica because
                    the lexical rules state that a floating point number must have a digit before the decimal point.
                    However, several tools will accept such numbers anyway.
                </td>
            </tr>
            <tr>
